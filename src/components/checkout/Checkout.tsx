                                ...
                                <div className="w-full flex items-center">
                                    <div className="overflow-hidden rounded-lg w-16 h-16 bg-gray-50 border border-gray-200">
                                        <Image
                                            ...
                                            src="https://images.unsplash.com/photo-1572635196237-14b3f281503f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1160&q=80" alt="Image" />
                                    </div>
                        ...
                        <div className="px-3 md:w-5/12">
                            <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 p-3 text-gray-800 font-light mb-6">
                                <div className="w-full flex mb-3 items-center">
                                    ...
                                    <div className="flex-grow pl-3">
                                        <input className="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="youremail@example.com" type="email" />
                                    </div>
                                </div>
                                <div className="w-full flex items-center">
                                    <div className="w-32">
                                    ...
                                    <div className="flex-grow pl-3">
                                        <input className="w-full px-3 py-2 border border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors" placeholder="Your billing address" type="text" />
                                    </div>
                                </div>
                            </div>
                            <div className="w-full mx-auto rounded-lg bg-white border border-gray-200 text-gray-800 font-light mb-6">
                                ...
                                <div className="w-full p-3">
                                    ...
                                    <Image
                                        ...
                                        height={20}
                                        alt="PayPal"
                                        src="https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg" className="ml-3" />
                                </div>
                            </div>
                            <div>
