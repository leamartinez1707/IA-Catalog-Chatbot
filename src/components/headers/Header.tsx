...
const Header = () => {
    const { setShowChat, showChat, setShowCart, showCart } = useAppStore()
                ...
                <div className="flex flex-col gap-4 py-1">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        <div className="flex items-center justify-between gap-4">
                            <Link href={'/'} className="flex items-center gap-3" aria-label="Go to ShopSmart AI home">
                                ...
                                <div>
                                        <p className="font-display text-lg font-semibold tracking-tight text-slate-950 sm:text-xl">
                                        ShopSmart AI
                                    </p>
                        ...
                        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                            ...
                            <Link
                                href={'/favorites'}
                                className="relative flex h-11 items-center rounded-full border border-slate-200 bg-white px-4 text-sm font-medium text-slate-700 transition-colors hover:border-slate-300 hover:bg-slate-50 hover:text-slate-950"
                            >
                    ...
                    <div className="flex flex-col gap-3 border-t border-slate-200/70 pt-4 lg:flex-row lg:items-center lg:justify-between">
                        <div className="w-full max-w-2xl">
                            <Suspense fallback={
                                <div className="h-12 rounded-full border border-slate-200 bg-white shadow-sm" />
                            }>
                                <SearchBar />
                            </Suspense>
                        </div>
